  ...
  const services = [
    {
      ...
      benefit: "Waa aasaaska saxda ah ee aad ku baraneyso suuqa adigoo ka badbaadaya jahwareerka.",
      color: "#f5c518",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex flex-1 items-center justify-center px-5 md:px-16 text-center py-16">
          <div className="max-w-4xl w-full">
            <h1 className="font-black leading-tight mb-6 uppercase"
            ...
            <p className="text-base md:text-lg leading-relaxed mb-10 mx-auto"
            ...
            <div className="flex gap-4 flex-wrap justify-center">
              ...
              <a href="#services"
                ...
                style={{ border: "1px solid rgba(245,197,24,0.4)", color: "#f5c518", background: "rgba(245,197,24,0.05)" }}>
                ▶ Our Services
              </a>
            </div>
          </div>
        ...
        {/* STATS BAR */}
        <div className="relative z-10 mx-5 md:mx-16 mb-8 md:mb-10"
          ...
          {services.map((svc, i) => (
            <div key={i} className="rounded-3xl p-7 md:p-9 flex flex-col gap-6 transition-all duration-300"
              ...
              <div className="rounded-2xl p-4"
                style={{ background: "rgba(0,0,0,0.25)", border: `1px solid ${svc.colorBorder}` }}>
                <p className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: svc.color }}>
                  ✦ Faa'iidada
                </p>
      ...
      <section id="contact" className="px-5 md:px-20 py-16 md:py-24 text-center"
        ...
        <p className="text-base md:text-xl mb-8" style={{ color: "#64748b" }}>
